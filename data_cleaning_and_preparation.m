...
input_prices_file = 'data\closed_prices.csv';
output_file = 'closed_prices_data.mat';
...
try
    ...
    error('Failed to load price data. Please consider to recheck your input file.');
end
...
if any(extreme_returns(:))
    fprintf('Warning: Found %d very high daily returns (>50%).\n', sum(extreme_returns(:)));
...
fprintf('Data processing complete! Your data is now ready for further steps.\n');
